...
```
## Что реализовано:
- Выбор базы данных при запуске приложения
- Добавление записи о расходе при нажатии кнопки "Добавить" в главном меню
- Удаление выделенных записей о расходе при нажатии кнопки "Удалить выбранные записи" в главном меню
- Редактирование записей о расходах производится в таблице по двойному клику
- Редактирование ограничений на бюджет производится в таблице по двойному клику
- Столбец "Сумма" в таблице "Бюджет" не редактируется пользователем
- Сохранение результатов редактирования таблиц ("Бюджет", "Последние расходы") при нажатии кнопки 
"Сохранить изменения" в главном меню
- Изменение списка категорий производится в отдельном окне по кнопке "Редактировать"
- Добавление новой категории при нажатии кнопки "Добавить" в окне
- Удаление выделенной категории при нажатии кнопки "Удалить выбранную категорию" в окне
- При удалении категории все траты данной категории удаляются
- Редактирование записей о категориях производится в таблице по двойному клику
- Сохранение результатов редактирования таблицы при нажатии кнопки "Сохранить изменения" в окне
- Обработка некорректного ввода пользователя: всплывающие окна с ошибками
- Предупреждение пользователя всплывающим окном при превышении ограничения бюджета суммой расходов
